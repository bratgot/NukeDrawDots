...
---
  ...
  Release         The Draw Dots panel opens, previewing the result
...
are about to get.
  ...
  Connect ...     If the stroke started on a node, the first Dot is wired
                  to it. If it ended on a node, that node's first input is
                  wired to the last Dot. The checkbox names whatever was
                  found, and is greyed out when neither end landed on
                  anything.
